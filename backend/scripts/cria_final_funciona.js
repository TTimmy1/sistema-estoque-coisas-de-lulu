...
SQL().then(SQL => {
  ...
  db.exec('CREATE TABLE Encomenda_new (id TEXT PRIMARY KEY, produtoId TEXT, produto TEXT, quantidade INTEGER, custo_unit REAL, custo_total REAL, estado TEXT, clienteId TEXT, vendedorId TEXT, criado_em DATETIME, atualizado_em DATETIME, pedido TEXT)');
