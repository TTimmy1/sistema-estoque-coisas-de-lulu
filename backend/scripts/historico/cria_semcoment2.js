...
SQL().then(SQL => {
  ...
  db.exec('CREATE TABLE PedidoInfo (id TEXT PRIMARY KEY, texto TEXT, preco REAL, data_pedido DATETIME DEFAULT datetime(''now''), data_entrega DATETIME, estado TEXT, clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT datetime(''now''), atualizado_em DATETIME DEFAULT datetime(''now''))');
  console.log('PedidoInfo OK');
  db.exec('CREATE TABLE Encomenda (id TEXT PRIMARY KEY, produtoId TEXT, produto TEXT, quantidade INTEGER, custo_unit REAL, custo_total REAL, estado TEXT, clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT datetime(''now''), pedido TEXT)');
  ...
  console.log('Inserindo Vendedor...');
  ...
  db.exec('INSERT INTO Movimentacao VALUES (''cmo0f41te0003gwycpmp8t1a5'',''cmo0cbnm90001gwiw0oq8qc6c'',''cmo0feqia0006gwyce7qo8kko'',''ENTRADA'',12,80,960,''sara'',''2026-04-15 20:31:56'',''2026-04-15 20:31:56'')');
  db.exec('INSERT INTO Movimentacao VALUES (''cmo0fgi9f000agwycmp3omw29'',''cmo0cbnm90001gwiw0oq8qc6c'',''cmo0feqia0006gwyce7qo8kko'',''SAIDA_VENDA'',1,80,80,''jamima'',''2026-04-15 20:32:30'',''2026-04-15 20:32:30'')');
  db.exec('INSERT INTO Movimentacao VALUES (''cmo0mmw080004gw90ceua06dt'',''cmo0mj4af0000gw90x8l19px3'',''cmo0mm2a40002gw90p8wcs6b1'',''ENTRADA'',3,90,270,''sara'',''2026-04-16 14:13:25'',''2026-04-16 14:13:25'')');
  db.exec('INSERT INTO Movimentacao VALUES (''cmo0mo8i40006gw90ilmoethc'',''cmo0mj4af0000gw90x8l19px3'',''cmo0mm2a40002gw90p8wcs6b1'',''SAIDA_VENDA'',1,90,90,''nome na garrafa THIAGO '',''2026-04-16 14:14:28'',''2026-04-16 14:14:28'')');
  ...
  console.log('Criando tabela Encomenda_new...');
  db.exec('CREATE TABLE Encomenda_new (id TEXT PRIMARY KEY, produtoId TEXT, produto TEXT, quantidade INTEGER, custo_unit REAL, custo_total REAL, estado TEXT, clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT datetime(''now''), pedido TEXT)');
  console.log('Inserindo dados em Encomenda_new...');
  db.exec('INSERT INTO Encomenda_new SELECT *, ''Encomenda personalizada'' FROM Encomenda');
  console.log('Removendo tabela Encomenda...');
  db.exec('DROP TABLE Encomenda');
  console.log('Renomeando Encomenda_new para Encomenda...');
