...
SQL().then(SQL => {
  ...
  db.exec('CREATE TABLE Pedido (id TEXT PRIMARY KEY, texto TEXT, preco REAL, data_pedido DATETIME DEFAULT (datetime(\'now\')), data_entrega DATETIME, estado TEXT DEFAULT \'EM_PRODUCAO\', clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT (datetime(\'now\')), atualizado_em DATETIME DEFAULT (datetime(\'now\')))');
  ...
  db.exec('INSERT INTO Usuario VALUES (\'cmo0cbnm90001gwiw0oq8qc6c\',\'timoteo\',\'claushsg@gmail.com\',\'\$2b\$10\$U/TnA3tvZE.M6IH4lML2R.XuFl/ySSP6z09CYDu1tkBzcgeRlaQcq\',\'2026-04-15 17:44:45\',NULL)');
