...
SQL().then(SQL => {
  ...
  db.exec(`CREATE TABLE Pedido (id TEXT PRIMARY KEY, texto TEXT, preco REAL, data_pedido DATETIME DEFAULT (datetime('now')), data_entrega DATETIME, coluna_estado TEXT DEFAULT 'EM_PRODUCAO', clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT (datetime('now')), atualizado_em DATETIME DEFAULT (datetime('now')))`);
  db.exec(`CREATE TABLE Encomenda (id TEXT PRIMARY KEY, produtoId TEXT, produto TEXT, quantidade INTEGER, custo_unit REAL, custo_total REAL, coluna_estado TEXT, clienteId TEXT, vendedorId TEXT, criado_em DATETIME DEFAULT (datetime('now')), pedido TEXT)`);
  ...
  db.exec(`INSERT INTO Encomenda VALUES
    ...
    ('cmo0mo8i40006gw90ilmoethc','cmo0mj4af0000gw90x8l19px3','cmo0mm2a40002gw90p8wcs6b1','SAIDA_VENDA',1,90,90,'nome na garrafa THIAGO ','cmo0eehgm0000gw0km9bj8osy','2026-04-16 14:14:28','2026-04-16 14:14:28');
  `);
