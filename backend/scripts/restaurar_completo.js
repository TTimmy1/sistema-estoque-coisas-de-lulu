...
SQL().then(SQL => {
  ...
  db.exec(`INSERT OR IGNORE INTO Usuario VALUES
  ...
  db.exec(`INSERT OR IGNORE INTO Vendedor VALUES ('cmo0eehgm0000gw0km9bj8osy','Timy','2026-04-15 18:42:56','','');`);

  db.exec(`INSERT OR IGNORE INTO Categoria VALUES
  ...
  db.exec(`INSERT OR IGNORE INTO Produto VALUES
  ...
  db.exec(`INSERT OR IGNORE INTO Movimentacao VALUES
  ...
  db.exec(`INSERT OR IGNORE INTO Cliente VALUES
    ('cmo0druqn0001gwjkd24uuyh6','nome na garrafa THIAGO ','14001010101010','2026-04-16 14:14:28');
  `);

  db.exec(`INSERT OR IGNORE INTO Encomenda VALUES
  ...
  console.log('Banco restaurado e atualizado com sucesso!');
